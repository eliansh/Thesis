...
echo"	<table style='width: 90%'>
	<tr>";
	$db2 = new dbArea();
if($db2->SelectAll() != NULL){
	$groupCount =$db->GetNumOfRows ();
	for($i = 0; $i < $groupCount; $i ++) {
	
		$arr = array();
	
		echo "<tr><td align='center'>";
		echo "<table style='width: 100%' class='border'><tr><td style='width: 35%'>";
		echo "<img src='http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|" . $arr [1] . "' />";
		//echo "<div class='ColorBox' style='Background-color:#" . $arr [2] . "' /></td>";
		echo "<td style='width: 65%'><b>";
		if ($arr [1] == "")
			echo "> " . $arr [0];
			else
				echo $arr [0] . " - " . $arr [1];
		...
		echo"<tr>
		<td align='center'>
			<table style='width: 100%' class='border'><tr><td style='width: 35%'>
				<img src='../Images/marker/'".$i."'.png' />
				<!-- <div class='ColorBox' style='Background-color: #666666' /> -->
				</td>
				<td style='width: 65%'><b>N/A</b>
						</td></tr></table>	
					</tr>
				</table></div>
			</fieldset>
