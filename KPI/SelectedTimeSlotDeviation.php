...
if ($db->selectDeviation_TimeSlot ( $Date, $station, $timeslot ) != NULL) {
	...
	for($i = 0; $i < $Count; $i ++) {
		...
		$rowDeviationFree="['".$dbRow ["Hour"]."',".$minFree.",".$avgFree.",".$avgFree.",".$maxFree.",'".$tooltipFree."']";
		$rowDeviationBikes="['".$dbRow ["Hour"]."',".$minBikes.",".$avgBikes.",".$avgBikes.",".$maxBikes.",'".$tooltipBikes."']";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChartFree(){
    	  ...
    	  data.addColumn('string', 'Time slot'); // Implicit domain label col.
