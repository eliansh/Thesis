...
Utilities::CheckAuthentication("../","KPI/DailyAvailability.php");
$TimeSlot = "0-23";
$StationName ="Re Umberto";
$Date="2015/09/04";


$Template = new Template ( "Daily Availability Report", "../" );
$Template->getHeader ();
...
echo <<<END
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Average Number Chart: Station $StationName on Date $Date
				...
				<div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Devation Chart: Station $StationName on Date $Date
