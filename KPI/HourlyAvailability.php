...
Utilities::CheckAuthentication("../","KPI/HourlyAvailability.php");
$Hour = "17";
$StationName ="Re Umberto";
$Date="2015/09/04";


$Template = new Template ( "Hourly Availability Report", "../" );
$Template->getHeader ();
...
echo <<<END
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Average Number Chart: Station $StationName on Date $Date on Hour $Hour:00
                            
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
      					<iframe height="1600px" width="100%" frameborder="0" scrolling="no" id='frameChart2' onload="iframeLoaded()"
						src="SelectedHourAvailability.php?date=$Date&station=$StationName&hour=$Hour"></iframe>                     
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
...
/*<div class="col-lg-10">
 <div class="panel panel-default">
 <div class="panel-heading">
 <i class="fa fa-bar-chart-o fa-fw"></i> Deviation Chart: Station $StationName on Date $Date on Hour $Hour:00

 </div>
 <!-- /.panel-heading -->
 <div class="panel-body">
 <iframe height="800px" width="100%" frameborder="0" scrolling="no" id='frameChart2' onload="iframeLoaded()"
 src="SelectedHourlyDeviation.php?date=$Date&station=$StationName&hour=$Hour"></iframe>
 </div>
 <!-- /.panel-body -->
 </div>
 <!-- /.panel -->
