...
$Template = new Template ( "Time-Period Interaction Report", "../" );
$Template->getHeader ();
...
echo <<<END
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Station $StationName between Dates $DateRange
                              </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
							 <iframe height='1600px' width='100%' frameborder='0' scrolling='no' id='frameChart2' onload='iframeLoaded()'
						src='SelectedTimePeriodUsage.php?selectedDateRange=$DateRange&station=$StationName'></iframe>                     
