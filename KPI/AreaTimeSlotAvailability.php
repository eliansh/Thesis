...
Utilities::CheckAuthentication("../","KPI/AreaTimeSlotAvailability.php");
$TimeSlot = "17-20";
$Area ="1";
$Date="2015/09/04";


$Template = new Template ( "Area Time-Slot Availability Report", "../" );
$Template->getHeader ();
...
echo"
                ...
                <div class='col-lg-10'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-bar-chart-o fa-fw'></i> Total availability Chart: Area $Area , Date $Date , TimeSlot "; $tt=str_replace("-",":00 - ",$TimeSlot); echo"$tt:00
                            
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
      					<iframe height='1600px' width='100%' frameborder='0' scrolling='no' id='frameChart2' onload='iframeLoaded()'
						src='SelectedAreaTimeSlotAvailability.php?date=$Date&area=$Area&timeslot=$TimeSlot'></iframe>                     
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
