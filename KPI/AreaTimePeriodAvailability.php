...
Utilities::CheckAuthentication("../","KPI/AreaTimePeriodAvailability.php");
$TimeSlot = "0-23";
$Area ="1";
...
$Template = new Template ( "Area Time-Period Availability Report", "../" );
$Template->getHeader ();
...
echo <<<END
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Total Number Chart: Area $Area between Dates $DateRange</div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
	  						<iframe height='1600px' width='100%' frameborder='0' scrolling='no' id='frameChart2' onload='iframeLoaded()'
						src='SelectedAreaTimePeriodAvailability.php?selectedDateRange=$DateRange&area=$Area'></iframe>                     
      					  </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
