...
Utilities::CheckAuthentication("../","KPI/TimeSlotAvailability.php");
$TimeSlot = "17-20";
$StationName ="Re Umberto";
$Date="2015/09/04";


$Template = new Template ( "Time-Slot Availability Report", "../" );
$Template->getHeader ();
...
echo"
                ...
                <div class='col-lg-10'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-bar-chart-o fa-fw'></i> Average availability Chart: Station $StationName , Date $Date , TimeSlot "; $tt=str_replace("-",":00 - ",$TimeSlot); echo"$tt:00
                            
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
      					<iframe height='1600px' width='100%' frameborder='0' scrolling='no' id='frameChart2' onload='iframeLoaded()'
						src='SelectedTimeSlotAvailability.php?date=$Date&station=$StationName&timeslot=$TimeSlot'></iframe>                     
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
 				...
 				<div class='col-lg-10'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-bar-chart-o fa-fw'></i> Deviation Chart: Station $StationName , Date $Date , TimeSlot "; $tt=str_replace("-",":00 - ",$TimeSlot); echo"$tt:00
                            
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
      					<iframe height='800px' width='100%' frameborder='0' scrolling='no' id='frameChart2' onload='iframeLoaded()'
						src='SelectedTimeSlotDeviation.php?date=$Date&station=$StationName&timeslot=$TimeSlot'></iframe>                     
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
