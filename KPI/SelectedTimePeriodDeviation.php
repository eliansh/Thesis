...
if ($db->selectDeviation_TimePeriod(  $StartDate, $EndDate, $station ) != NULL) {
	...
	for($i = 0; $i < $Count; $i ++) {
		...
		$rowDeviationFree="['".$dbRow ["Date"]."',".$minFree.",".$avgFree.",".$avgFree.",".$maxFree.",'".$tooltipFree."']";
		$rowDeviationBikes="['".$dbRow ["Date"]."',".$minBikes.",".$avgBikes.",".$avgBikes.",".$maxBikes.",'".$tooltipBikes."']";
