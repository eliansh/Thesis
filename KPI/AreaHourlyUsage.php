...
Utilities::CheckAuthentication("../","KPI/AreaHourlyUsage.php");
$Hour = "17";
$Area ="15";
$Date="2015/09/04";


$Template = new Template ( "Area Hourly Usage Report", "../" );
$Template->getHeader ();
...
echo <<<END
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Usage Chart: Area $Area on Date $Date on Hour $Hour:00
                            
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
      					<iframe height="1600px" width="100%" frameborder="0" scrolling="no" id='frameChart2' onload="iframeLoaded()"
						src="SelectedAreaHourUsage.php?date=$Date&area=$Area&hour=$Hour"></iframe>                     
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
