...
Utilities::CheckAuthentication("../","KPI/AreaDailyAvailability.php");
$TimeSlot = "0-23";
$Area ="1";
$Date="2015/09/04";


$Template = new Template ( "Area Daily Availability Report", "../" );
$Template->getHeader ();
...
echo <<<END
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Total Number Chart: Area $Area on Date $Date
