...
Utilities::CheckAuthentication("../","KPI/AreaTimeSlotUsage.php");
$TimeSlot = "17-20";
$Area ="1";
$Date="2015/09/04";


$Template = new Template ( "Area Time-Slot Usage Report", "../" );
$Template->getHeader ();
...
END;
			echo"<option value='00-11'"; if($TimeSlot=="00-11") echo "selected"; echo" >Morning (from 00:00 until 12:00)</option>
...
echo"
                ...
                <div class='col-lg-10'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-bar-chart-o fa-fw'></i> Usage Chart: Area $Area , Date $Date , TimeSlot "; $tt=str_replace("-",":00 - ",$TimeSlot); echo"$tt:00
